        ...
        <div id="content">
            ...
            <div class="container-fluid">
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    ...
                    <button class="btn btn-primary" data-toggle="modal" data-target="#addUserModal"><i class="fas fa-plus fa-sm text-white-50"></i> Tambah Pengguna</button>
                </div>
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3 d-flex justify-content-between align-items-center">
                        <h6 class="m-0 font-weight-bold text-primary">Daftar Pengguna (<?php echo (int)$total_records; ?> total)</h6>
                    ...
                    <div class="card-body">
                        <form method="GET" action="" class="form-inline mb-3">
                            ...
                            <input type="text" name="search" class="form-control form-control-sm mr-3" placeholder="Username/Email/Nama/Telepon" value="<?php echo htmlspecialchars($search); ?>">
                            <label class="mb-0 mr-2">Peran:</label>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td style="width:70px"><img src="<?php echo htmlspecialchars(assetUrlAdmin(!empty($u['profile_image']) ? $u['profile_image'] : 'assets/img/placeholder.png')); ?>" alt="img" width="60"></td>
                                        ...
                                        <td>
                                            ...
                                            <form method="POST" action="" style="display:inline-block;" onsubmit="return confirm('Hapus pengguna ini?')">
                                                <input type="hidden" name="csrf_token" value="<?php echo htmlspecialchars($_SESSION['csrf_token']); ?>">
                                                <input type="hidden" name="user_id" value="<?php echo (int)$u['id']; ?>">
        ...
        <form method="POST" action="" enctype="multipart/form-data" class="needs-validation" novalidate>
          ...
          <div class="form-row">
            <div class="form-group col-md-6">
              ...
              <div><img src="<?php echo htmlspecialchars(assetUrlAdmin(!empty($u['profile_image']) ? $u['profile_image'] : 'assets/img/placeholder.png')); ?>" width="100"></div>
...
<div class="modal fade" id="viewUserModal<?php echo (int)$u['id']; ?>" tabindex="-1" role="dialog">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="mb-3 text-center"><img src="<?php echo htmlspecialchars(assetUrlAdmin(!empty($u['profile_image']) ? $u['profile_image'] : 'assets/img/placeholder.png')); ?>" alt="<?php echo htmlspecialchars($u['username']); ?>" style="max-height: 120px; width: auto;" /></div>
